            ...
            <div style={bgImage}>
                <div className="container mx-aut min-h-[550px] flex justify-center items-center py-12 sm:py-0 ">
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                        <div>
                            <img data-aos="zoom-in" src={BannerImg} alt="" className='max-w-[430px] w-full mx-auto spin drop-shadow-xl' />
                        </div>
                        <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                            <h1 data-aos="fade-up" className='text-3xl sm:text-4xl font-bold font-pacifico'>Premium Blen Coffee</h1>
                            <p data-aos="fade-up" className='text-sm text-gray-500 tracking-wide leading-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum, voluptas accusantium. Numquam sed tempora ex explicabo velit.</p>
